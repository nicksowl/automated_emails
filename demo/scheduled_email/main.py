# This is automation script depending from data from external Google sheet. It uses "send_email" script. This script can be upload to VPS and run with cron job.
